...
int main() {
    studentas stud_2;
    stud_2.setVardas("ss");
    stud_2.setPavarde("ss");
    stud_2.setEgzaminas(4);
    stud_2.setPazymiai(6);
    stud_2.setPazymiai(7);
    stud_2.setPazymiai(8);
    studentas stud_3(stud_2);

    studentas stud_4;
    stud_4 = stud_3;

    studentas stud_5;
    stud_5 = std::move(studentas("vardas", "pavarde")); 
